...
class CryptoCurrencyRatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'currency_id' => ['type' => 'integer', 'length' => 4, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => 'default currency is in USD', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'UNQ_CRYPTO_RATE_ID' => ['type' => 'unique', 'columns' => ['crypto_currency_id', 'currency_id'], 'length' => []],
            'UNQ_CRYPTO_RATE_NAME_SYMBOL' => ['type' => 'unique', 'columns' => ['crypto_currency_name', 'symbol', 'currency_name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
